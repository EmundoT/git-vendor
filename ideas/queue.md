...
| 004 | completed | Comprehensive Test Suite | Core coverage 81.1%, integration tests for all commands | - |
...
| ID | Status | Title | Brief | Spec |
|----|--------|-------|-------|------|
| 071 | completed | Position Extraction | Line/column range extraction in path mappings (from: file:L5-L20) | [spec](specs/complete/071-position-extraction.md) |
| 072 | completed | LLM-Friendly CLI | CLI commands for vendor management without editing YAML, JSON output | [spec](specs/complete/072-llm-friendly-cli.md) |
...
| 041 | pending | Expand Hook Events | Add pre-add, pre-verify, post-verify, post-update hook events beyond existing pre/post sync | - |
...
070 (Internal Compliance) ✅ [independent of 075]
