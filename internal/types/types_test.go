...
// TestVendorStatus_SyncStateConsistency — REMOVED (T7): tautological struct-assignment test.
// TestSyncStatus_Aggregation — REMOVED (T7): tautological struct-assignment test.
// TestUpdateCheckResult_UpdateLogic — REMOVED (T7): tautological struct-assignment test.
// VendorStatus, SyncStatus, and UpdateCheckResult have no methods; these tests only
// verified that reading a struct field returns the value that was assigned to it.
